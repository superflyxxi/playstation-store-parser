...
assertEquals("MetaCriticURL", "https://www.metacritic.com/game/playstation-4/scrabble", $psGame->getMetaCriticURL());
assertEquals("MetaCriticScore", NULL, $psGame->getMetaCriticScore());
