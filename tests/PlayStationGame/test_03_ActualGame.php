...
assertEquals("MetaCritic Score", true, $psGame->getMetaCriticScore() > 0);
assertEquals("MetaCritic URL", "https://www.metacritic.com/game/playstation-4/the-last-of-us-remastered", $psGame->getMetaCriticURL());
?>
